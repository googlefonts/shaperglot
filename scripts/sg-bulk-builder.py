...
with open('./data/ot-lang-tags.yaml', 'r') as f:
...
def main():
    ...
    print(
        "African ISO-639 tags:\t"
        + str(all_tags)
        + "\nAvailable GF Lang Record:\t"
        + str(with_record)
        + "\nGF Lang Contains Exemplar Characters:\t"
        + str(with_exemplars)
        + "\nCorresponding OT Lang Tag Exists:\t"
        + str(with_ot_tags)
        + "\nNeeds Glyphs Variant:\t"
        + str(needs_variant)
    )
